...
const LandingPage = ({ getUsers, setUserAttempt, userAttempt, authenticate }) => {
  return (
    <div className="w-100">
      <h1 className="border-bottom border-top border-dark border-2 pb-3 pt-3 mt-2">Welcome to our Bookstore System!</h1>
      ...
      <div className="login-label">
        <h3 className="border-bottom border-dark border-2 pb-3">Log In to Access the Inventory System</h3>
