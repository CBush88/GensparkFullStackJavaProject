...
const Home = () => {
  return (
    <div className="container mt-4">
      ...
      <p>Non nisi sunt occaecat nisi duis. Amet nostrud enim commodo aliquip magna veniam. Mollit pariatur esse dolor eu.</p>

      <p>Voluptate veniam commodo occaecat occaecat laboris magna amet est. Duis aliqua excepteur Lorem est ea laborum veniam aliquip ea sunt velit. Est pariatur magna qui duis cupidatat fugiat cillum pariatur est.</p>
    </div>
  );
}
